...
const config = {
  plugins: ["@csstools/postcss-cascade-layers",
    propertyInjectPlugin(),
    colorMixVarResolverPlugin(),
    transformShortcutPlugin(),
    addSpaceForEmptyVarFallback(),
    'postcss-media-minmax', '@csstools/postcss-oklab-function', '@csstools/postcss-color-mix-function',
    'postcss-nesting', "@tailwindcss/postcss", 'autoprefixer'],
};
